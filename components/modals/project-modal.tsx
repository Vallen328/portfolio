                            ...
                            <div className="flex flex-wrap gap-4 pt-4 border-t border-border/50">
                                ...
                                {project.repo && (
                                    <ShineButton
                                        ...
                                        className={
                                            project.demo
                                                ? "h-12 bg-secondary/10 backdrop-blur-md px-6 sm:px-8 text-foreground hover:bg-foreground hover:text-background shadow-sm hover:-translate-y-1"
                                                : "h-12 bg-foreground px-6 sm:px-8 text-background hover:bg-background hover:text-foreground shadow-lg hover:-translate-y-1"
                                        }
                                        shineClassName={
                                            project.demo
                                                ? "w-8 bg-foreground/10 dark:bg-background/20"
                                                : "w-8 bg-background/20 dark:bg-foreground/10"
                                        }
                                    >
                                        <span className="relative z-10 flex items-center gap-2 text-xs sm:text-sm font-medium tracking-widest uppercase">
                                            {dict.sourceCode}
