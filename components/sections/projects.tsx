            ...
            >
                ...
                {!isDesktop ? (
                    <>
                        ...
                        <div className="flex justify-center mt-12 px-container">
                            <BlurReveal>
                                <a
                                    href="https://github.com/Vallen328"
                                    target="_blank"
                                    rel="noopener noreferrer"
                                    className="group inline-flex items-center gap-3 text-xs sm:text-sm font-mono tracking-widest uppercase text-foreground py-4 px-8 border border-border/50 bg-secondary/10 backdrop-blur-md rounded-full hover:bg-secondary/30 hover:border-foreground/30 transition-all duration-300 shadow-lg"
                                >
                                    <Github className="w-4 h-4 transition-transform group-hover:rotate-12" />
                                    <span>{dict.projectsEndText}</span>
                    ...
                    >
                        ...
                        <a
                            ...
                            target="_blank"
                            rel="noopener noreferrer"
                            className="w-[40vw] h-[70vh] shrink-0 flex flex-col justify-center items-center group cursor-pointer text-center px-8"
                        >
                            <h3 className="text-[5vw] xl:text-[4vw] font-black tracking-tighter text-muted-foreground/40 uppercase transition-all duration-500 group-hover:text-foreground group-hover:scale-105 leading-none">
                                {dict.projectsEndText}
                            </h3>
                            <div className="mt-6 flex items-center gap-3 text-muted-foreground transition-all duration-500 group-hover:text-foreground group-hover:scale-110">
